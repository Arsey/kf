...
class PostController extends Controller
{
    public function indexAction()
    {
    	...
    	$section = $this->getDoctrine()->getRepository('BambukCmsClubBundle:Section')->findOneById(6);
        $type = 0;
    	return $this->render('BambukCmsContentBundle:Post:list.html.twig',array('posts'=>$posts, 'section'=>$section,'type' =>$type));
    }

    public function headerAction()
    {
        return $this->render('BambukCmsContentBundle:Post:header.html.twig');
    }
    ...
    public function footerAction()
    {
    	...
    	return $this->render('BambukCmsContentBundle:Home:footer.html.twig',array('cities'=>$cities,'menu'=>$menu,'type' =>$type));
    }
     public function showPostAction($id)
    {   
    	$post = $this->getDoctrine()->getRepository('BambukCmsPostBundle:Post')->findOneBy(array('id' => $id));
    	$section = $this->getDoctrine()->getRepository('BambukCmsClubBundle:Section')->findOneById(6);
    	$type = 0;
    	return $this->render('BambukCmsContentBundle:Post:show.html.twig',array('post'=>$post, 'section'=>$section,'type' =>$type));
    }    
    public function showPostTypeAction($type)
    {
    	$posts = $this->getDoctrine()->getRepository('BambukCmsPostBundle:Post')->findBy(array('active' => 1,'type' =>$type),array('sort' => 'ASC'));
    	$section = $this->getDoctrine()->getRepository('BambukCmsClubBundle:Section')->findOneById(6);
    	return $this->render('BambukCmsContentBundle:Post:list.html.twig',array('posts'=>$posts, 'section'=>$section,'type' =>$type));
    }    
    ...
    {   
		...
		$clubs = $this->getDoctrine()->getRepository('BambukCmsClubBundle:Club')->findOneById($id);
		$posts = $clubs->getPosts();
    	$arrPostIds=array();
